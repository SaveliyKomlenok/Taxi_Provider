...
class PassengerRatingController(
    ...
    @GetMapping("/{id}")
    fun getPassengerRating(@PathVariable id: Long): ResponseEntity<PassengerRatingResponse> {
    ...
    @PostMapping
    fun save(@RequestBody @Valid request: PassengerRatingRequest): ResponseEntity<PassengerRatingResponse> {
