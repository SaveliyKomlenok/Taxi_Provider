Feature: Ride
  ...
  Scenario: Create a ride successfully
    ...
    When I create a new ride with passenger id 2
  ...
  Scenario: Accept a ride successfully
    ...
    When I accept the ride with driver id 3
  ...
  Scenario: Finish a ride successfully
    ...
    When I finish the ride with driver id 3
  ...
  Scenario: Cancel a ride successfully
    ...
    When I cancel the ride with passenger id 2
  ...
  Scenario: Change ride status successfully
    ...
    When I change the ride status with driver id 3
  ...
  Scenario: Change ride status with invalid conditions
    ...
    When I change the ride status with driver id 1
